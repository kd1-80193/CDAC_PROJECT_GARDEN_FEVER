...
public class JwtHelper {
	public static final long JWT_TOKEN_VALIDIY = 5 * 60 * 60; // 5 minutes
	...
	// expire date(when token will expire)
	...
	private String doGenerateToken(Map<String, Object> claims, String subject) {
	    return Jwts.builder()
	            ...
	            .setExpiration(new Date(System.currentTimeMillis() + JWT_TOKEN_VALIDIY * 1000)) // after this token will expire
